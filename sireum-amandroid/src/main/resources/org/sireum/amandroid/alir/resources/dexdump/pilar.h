...
static char* pilarExtName(const char* str)
{
 ...
 #define  outConst4(x, y)          fprintf(pFp,"v%d:= %dI  @length Const4;", x, y)
 #define  outConst16(x, y)         fprintf(pFp,"v%d:= %dI  @length Const16;", x, y)
 #define  outConst32(x, y)         fprintf(pFp,"v%d:= %dI  @length Const32;", x, y)
...
#define          outUnopInt2Long(x, y)     fprintf(pFp,"v%d:= (long)v%d;", x, y)
#define          outUnopInt2Float(x, y)    fprintf(pFp,"v%d:= (float)v%d;", x, y)
#define          outUnopInt2Double(x, y)   fprintf(pFp,"v%d:= (double)v%d;", x, y)
#define          outUnopLong2Int(x, y)     fprintf(pFp,"v%d:= (int)v%d;", x, y)
#define          outUnopLong2Float(x, y)   fprintf(pFp,"v%d:= (float)v%d;", x, y)
#define          outUnopLong2Double(x, y)  fprintf(pFp,"v%d:= (double)v%d;", x, y)
#define          outUnopFloat2Int(x, y)    fprintf(pFp,"v%d:= (int)v%d;", x, y)
#define          outUnopFloat2Long(x, y)   fprintf(pFp,"v%d:= (long)v%d;", x, y)
#define          outUnopFloat2Double(x, y) fprintf(pFp,"v%d:= (double)v%d;", x, y)
#define          outUnopDouble2Int(x, y)   fprintf(pFp,"v%d:= (int)v%d;", x, y)
#define          outUnopDouble2Long(x, y)  fprintf(pFp,"v%d:= (long)v%d;", x, y)
#define          outUnopDouble2Float(x, y) fprintf(pFp,"v%d:= (float)v%d;", x, y)
#define          outUnopInt2Byte(x, y)   fprintf(pFp,"v%d:= (byte)v%d;", x, y)
#define          outUnopInt2Char(x, y)   fprintf(pFp,"v%d:= (char)v%d;", x, y)
#define          outUnopInt2short(x, y)  fprintf(pFp,"v%d:= (short)v%d;", x, y)
