...
object OFAPreprocessModule extends PipelineModule {
  ...
  def outputDefined (job : PipelineJob) : MBuffer[Tag] = {
    ...
    if(job ? OFAPreprocessModule.OFGKey && !job(OFAPreprocessModule.OFGKey).isInstanceOf[org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.interProcedural.objectFlowAnalysis.OfaNode, org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidValueSet]]) {
      tags += PipelineUtil.genTag(PipelineUtil.ErrorMarker, 
        "Output error for '" + this.title + "': Wrong type found for OFAPreprocessModule.OFGKey.  Expecting 'org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.interProcedural.objectFlowAnalysis.OfaNode, org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidValueSet]' but found '" + 
        job(OFAPreprocessModule.OFGKey).getClass.toString + "'")
    } 

    if(job ? OFAPreprocessModule.globalOFGKey && !job(OFAPreprocessModule.globalOFGKey).isInstanceOf[org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.interProcedural.objectFlowAnalysis.OfaNode, org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidValueSet]]) {
      tags += PipelineUtil.genTag(PipelineUtil.ErrorMarker, 
        "Output error for '" + this.title + "': Wrong type found for OFAPreprocessModule.globalOFGKey.  Expecting 'org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.interProcedural.objectFlowAnalysis.OfaNode, org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidValueSet]' but found '" + 
  ...
  def getAndroidLibInfoTables (options : scala.collection.Map[Property.Key, Any]) : org.sireum.amandroid.symbolResolver.AndroidLibInfoTables = {
    if (options.contains(OFAPreprocessModule.globalAndroidLibInfoTablesKey)) {
       return options(OFAPreprocessModule.globalAndroidLibInfoTablesKey).asInstanceOf[org.sireum.amandroid.symbolResolver.AndroidLibInfoTables]
    }
  ...
  def getOFG (options : scala.collection.Map[Property.Key, Any]) : org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.interProcedural.objectFlowAnalysis.OfaNode, org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidValueSet] = {
    if (options.contains(OFAPreprocessModule.globalOFGKey)) {
       return options(OFAPreprocessModule.globalOFGKey).asInstanceOf[org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.interProcedural.objectFlowAnalysis.OfaNode, org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidValueSet]]
    }
    if (options.contains(OFAPreprocessModule.OFGKey)) {
       return options(OFAPreprocessModule.OFGKey).asInstanceOf[org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.interProcedural.objectFlowAnalysis.OfaNode, org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidValueSet]]
    }

    throw new Exception("Pipeline checker should guarantee we never reach here")
  }

  def setOFG (options : MMap[Property.Key, Any], OFG : org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.interProcedural.objectFlowAnalysis.OfaNode, org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidValueSet]) : MMap[Property.Key, Any] = {
  ...
  object ConsumerView {
    implicit class OFAPreprocessModuleConsumerView (val job : PropertyProvider) extends AnyVal {
      ...
      def androidLibInfoTables : org.sireum.amandroid.symbolResolver.AndroidLibInfoTables = OFAPreprocessModule.getAndroidLibInfoTables(job.propertyMap)
      def OFG : org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.interProcedural.objectFlowAnalysis.OfaNode, org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidValueSet] = OFAPreprocessModule.getOFG(job.propertyMap)
    }
  }
  ...
  object ProducerView {
    implicit class OFAPreprocessModuleProducerView (val job : PropertyProvider) extends AnyVal {
      ...
      def androidLibInfoTables_=(androidLibInfoTables : org.sireum.amandroid.symbolResolver.AndroidLibInfoTables) { OFAPreprocessModule.setAndroidLibInfoTables(job.propertyMap, androidLibInfoTables) }
      def androidLibInfoTables : org.sireum.amandroid.symbolResolver.AndroidLibInfoTables = OFAPreprocessModule.getAndroidLibInfoTables(job.propertyMap)

      def OFG_=(OFG : org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.interProcedural.objectFlowAnalysis.OfaNode, org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidValueSet]) { OFAPreprocessModule.setOFG(job.propertyMap, OFG) }
      def OFG : org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.interProcedural.objectFlowAnalysis.OfaNode, org.sireum.amandroid.android.interProcedural.objectFlowAnalysis.AndroidValueSet] = OFAPreprocessModule.getOFG(job.propertyMap)
    }
  }
}
