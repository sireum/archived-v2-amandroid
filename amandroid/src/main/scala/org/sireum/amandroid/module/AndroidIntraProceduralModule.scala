...
object AndroidIntraProceduralModule extends PipelineModule {
  ...
  override def initialize(job : PipelineJob) {
    if(!(job ? AndroidIntraProceduralModule.globalShouldBuildCfgKey)) {
      val shouldBuildCfg = Class.forName("org.sireum.amandroid.module.AndroidIntraProcedural").getDeclaredMethod("$lessinit$greater$default$4").invoke(null).asInstanceOf[scala.Boolean]
      setShouldBuildCfg(job.propertyMap, shouldBuildCfg)
    }

    if(!(job ? AndroidIntraProceduralModule.globalShouldBuildRdaKey)) {
      val shouldBuildRda = Class.forName("org.sireum.amandroid.module.AndroidIntraProcedural").getDeclaredMethod("$lessinit$greater$default$5").invoke(null).asInstanceOf[scala.Boolean]
      setShouldBuildRda(job.propertyMap, shouldBuildRda)
    }

    if(!(job ? AndroidIntraProceduralModule.globalShouldBuildPagKey)) {
      val shouldBuildPag = Class.forName("org.sireum.amandroid.module.AndroidIntraProcedural").getDeclaredMethod("$lessinit$greater$default$6").invoke(null).asInstanceOf[scala.Boolean]
      setShouldBuildPag(job.propertyMap, shouldBuildPag)
    }

    if(!(job ? AndroidIntraProceduralModule.globalShouldPreprocessOfgKey)) {
      val shouldPreprocessOfg = Class.forName("org.sireum.amandroid.module.AndroidIntraProcedural").getDeclaredMethod("$lessinit$greater$default$7").invoke(null).asInstanceOf[scala.Boolean]
      setShouldPreprocessOfg(job.propertyMap, shouldPreprocessOfg)
    }

    if(!(job ? AndroidIntraProceduralModule.globalShouldBuildCCfgKey)) {
      val shouldBuildCCfg = Class.forName("org.sireum.amandroid.module.AndroidIntraProcedural").getDeclaredMethod("$lessinit$greater$default$8").invoke(null).asInstanceOf[scala.Boolean]
      setShouldBuildCCfg(job.propertyMap, shouldBuildCCfg)
    }

    if(!(job ? AndroidIntraProceduralModule.globalShouldIncludeFlowFunctionKey)) {
      val shouldIncludeFlowFunction = Class.forName("org.sireum.amandroid.module.AndroidIntraProcedural").getDeclaredMethod("$lessinit$greater$default$9").invoke(null).asInstanceOf[scala.Function2[org.sireum.pilar.ast.LocationDecl, scala.collection.Iterable[org.sireum.pilar.ast.CatchClause], scala.Tuple2[scala.collection.Iterable[org.sireum.pilar.ast.CatchClause], scala.Boolean]]]
    ...
    if(!(job ? AndroidIntraProceduralModule.globalDefRefKey)) {
      val defRef = Class.forName("org.sireum.amandroid.module.AndroidIntraProcedural").getDeclaredMethod("$lessinit$greater$default$10").invoke(null).asInstanceOf[scala.Function1[org.sireum.pilar.symbol.SymbolTable, org.sireum.alir.DefRef]]
      setDefRef(job.propertyMap, defRef)
    }

    if(!(job ? AndroidIntraProceduralModule.globalIsInputOutputParamPredicateKey)) {
      val isInputOutputParamPredicate = Class.forName("org.sireum.amandroid.module.AndroidIntraProcedural").getDeclaredMethod("$lessinit$greater$default$11").invoke(null).asInstanceOf[scala.Function1[org.sireum.pilar.symbol.ProcedureSymbolTable, scala.Tuple2[scala.Function1[java.lang.String, scala.Boolean], scala.Function1[java.lang.String, scala.Boolean]]]]
    ...
    if(!(job ? AndroidIntraProceduralModule.globalSwitchAsOrderedMatchKey)) {
      val switchAsOrderedMatch = Class.forName("org.sireum.amandroid.module.AndroidIntraProcedural").getDeclaredMethod("$lessinit$greater$default$12").invoke(null).asInstanceOf[scala.Boolean]
    ...
    if(!(job ? AndroidIntraProceduralModule.globalProcedureAbsUriIteratorKey)) {
      val procedureAbsUriIterator = Class.forName("org.sireum.amandroid.module.AndroidIntraProcedural").getDeclaredMethod("$lessinit$greater$default$13").invoke(null).asInstanceOf[scala.Option[scala.collection.Iterator[java.lang.String]]]
  ...
  def getDefRef (options : scala.collection.Map[Property.Key, Any]) : scala.Function1[org.sireum.pilar.symbol.SymbolTable, org.sireum.alir.DefRef] = {
    if (options.contains(AndroidIntraProceduralModule.globalDefRefKey)) {
       return options(AndroidIntraProceduralModule.globalDefRefKey).asInstanceOf[scala.Function1[org.sireum.pilar.symbol.SymbolTable, org.sireum.alir.DefRef]]
    }
  ...
  object ConsumerView {
    implicit class AndroidIntraProceduralModuleConsumerView (val job : PropertyProvider) extends AnyVal {
      ...
      def defRef : scala.Function1[org.sireum.pilar.symbol.SymbolTable, org.sireum.alir.DefRef] = AndroidIntraProceduralModule.getDefRef(job.propertyMap)
  ...
  object ProducerView {
    implicit class AndroidIntraProceduralModuleProducerView (val job : PropertyProvider) extends AnyVal {
      ...
      def defRef_=(defRef : scala.Function1[org.sireum.pilar.symbol.SymbolTable, org.sireum.alir.DefRef]) { AndroidIntraProceduralModule.setDefRef(job.propertyMap, defRef) }
      def defRef : scala.Function1[org.sireum.pilar.symbol.SymbolTable, org.sireum.alir.DefRef] = AndroidIntraProceduralModule.getDefRef(job.propertyMap)
