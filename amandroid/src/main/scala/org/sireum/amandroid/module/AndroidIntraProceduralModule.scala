...
object AndroidIntraProceduralModule extends PipelineModule {
  ...
  override def initialize(job : PipelineJob) {
    if(!(job ? AndroidIntraProceduralModule.globalAndroidCacheKey)) {
      val androidCache = Class.forName("org.sireum.amandroid.module.AndroidIntraProcedural").getDeclaredMethod("$lessinit$greater$default$5").invoke(null).asInstanceOf[scala.Option[org.sireum.amandroid.android.cache.AndroidCacheFile[java.lang.String]]]
    ...
    if(!(job ? AndroidIntraProceduralModule.globalDefRefKey)) {
      val defRef = Class.forName("org.sireum.amandroid.module.AndroidIntraProcedural").getDeclaredMethod("$lessinit$greater$default$13").invoke(null).asInstanceOf[scala.Function2[org.sireum.pilar.symbol.SymbolTable, org.sireum.amandroid.symbolResolver.AndroidLibInfoTables, org.sireum.alir.DefRef]]
  ...
  def getAndroidLibInfoTablesOpt (options : scala.collection.Map[Property.Key, Any]) : scala.Option[org.sireum.amandroid.symbolResolver.AndroidLibInfoTables] = {
    if (options.contains(AndroidIntraProceduralModule.globalAndroidLibInfoTablesOptKey)) {
       return options(AndroidIntraProceduralModule.globalAndroidLibInfoTablesOptKey).asInstanceOf[scala.Option[org.sireum.amandroid.symbolResolver.AndroidLibInfoTables]]
    }
  ...
  def getAndroidCache (options : scala.collection.Map[Property.Key, Any]) : scala.Option[org.sireum.amandroid.android.cache.AndroidCacheFile[java.lang.String]] = {
    if (options.contains(AndroidIntraProceduralModule.globalAndroidCacheKey)) {
       return options(AndroidIntraProceduralModule.globalAndroidCacheKey).asInstanceOf[scala.Option[org.sireum.amandroid.android.cache.AndroidCacheFile[java.lang.String]]]
    }
  ...
  def getDefRef (options : scala.collection.Map[Property.Key, Any]) : scala.Function2[org.sireum.pilar.symbol.SymbolTable, org.sireum.amandroid.symbolResolver.AndroidLibInfoTables, org.sireum.alir.DefRef] = {
    if (options.contains(AndroidIntraProceduralModule.globalDefRefKey)) {
       return options(AndroidIntraProceduralModule.globalDefRefKey).asInstanceOf[scala.Function2[org.sireum.pilar.symbol.SymbolTable, org.sireum.amandroid.symbolResolver.AndroidLibInfoTables, org.sireum.alir.DefRef]]
    }
  ...
  object ConsumerView {
    implicit class AndroidIntraProceduralModuleConsumerView (val job : PropertyProvider) extends AnyVal {
      ...
      def androidLibInfoTablesOpt : scala.Option[org.sireum.amandroid.symbolResolver.AndroidLibInfoTables] = AndroidIntraProceduralModule.getAndroidLibInfoTablesOpt(job.propertyMap)
      def androidCache : scala.Option[org.sireum.amandroid.android.cache.AndroidCacheFile[java.lang.String]] = AndroidIntraProceduralModule.getAndroidCache(job.propertyMap)
      ...
      def defRef : scala.Function2[org.sireum.pilar.symbol.SymbolTable, org.sireum.amandroid.symbolResolver.AndroidLibInfoTables, org.sireum.alir.DefRef] = AndroidIntraProceduralModule.getDefRef(job.propertyMap)
  ...
  object ProducerView {
    implicit class AndroidIntraProceduralModuleProducerView (val job : PropertyProvider) extends AnyVal {
      ...
      def androidLibInfoTablesOpt_=(androidLibInfoTablesOpt : scala.Option[org.sireum.amandroid.symbolResolver.AndroidLibInfoTables]) { AndroidIntraProceduralModule.setAndroidLibInfoTablesOpt(job.propertyMap, androidLibInfoTablesOpt) }
      def androidLibInfoTablesOpt : scala.Option[org.sireum.amandroid.symbolResolver.AndroidLibInfoTables] = AndroidIntraProceduralModule.getAndroidLibInfoTablesOpt(job.propertyMap)

      def androidCache_=(androidCache : scala.Option[org.sireum.amandroid.android.cache.AndroidCacheFile[java.lang.String]]) { AndroidIntraProceduralModule.setAndroidCache(job.propertyMap, androidCache) }
      def androidCache : scala.Option[org.sireum.amandroid.android.cache.AndroidCacheFile[java.lang.String]] = AndroidIntraProceduralModule.getAndroidCache(job.propertyMap)
      ...
      def defRef_=(defRef : scala.Function2[org.sireum.pilar.symbol.SymbolTable, org.sireum.amandroid.symbolResolver.AndroidLibInfoTables, org.sireum.alir.DefRef]) { AndroidIntraProceduralModule.setDefRef(job.propertyMap, defRef) }
      def defRef : scala.Function2[org.sireum.pilar.symbol.SymbolTable, org.sireum.amandroid.symbolResolver.AndroidLibInfoTables, org.sireum.alir.DefRef] = AndroidIntraProceduralModule.getDefRef(job.propertyMap)
