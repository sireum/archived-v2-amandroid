...
static char* pilarExtName(const char* str)
{
 ...
 #define  outConst32(x, y)         fprintf(pFp," v%d:= %f;", x, y)
 ...
 #define  outConstClass(x, y, z, u)      fprintf(pFp,"call v%d:= [|%s.class|]() @signature [|%s.class:()Ljava/lang/Class;|] @type %s;", x, y, z, u)
