package org.sireum.amandroid.transform
...
object Transform {
  ...
  val dr : (SymbolTable, AndroidLibInfoTables) => DefRef = { (st, alit) => new org.sireum.amandroid.androidObjectFlowAnalysis.AndroidDefRef(st, new org.sireum.amandroid.androidObjectFlowAnalysis.AndroidVarAccesses(st), alit) }
