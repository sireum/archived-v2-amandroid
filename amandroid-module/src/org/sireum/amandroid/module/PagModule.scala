...
object PagModule extends PipelineModule {
  ...
  def outputDefined (job : PipelineJob) : MBuffer[Tag] = {
    ...
    if(job ? PagModule.pagKey && !job(PagModule.pagKey).isInstanceOf[org.sireum.amandroid.pointsToAnalysis.PointerAssignmentGraph[org.sireum.amandroid.pointsToAnalysis.PtaNode]]) {
      tags += PipelineUtil.genTag(PipelineUtil.ErrorMarker, 
        "Output error for '" + this.title + "': Wrong type found for PagModule.pagKey.  Expecting 'org.sireum.amandroid.pointsToAnalysis.PointerAssignmentGraph[org.sireum.amandroid.pointsToAnalysis.PtaNode]' but found '" + 
        job(PagModule.pagKey).getClass.toString + "'")
    } 

    if(job ? PagModule.globalPagKey && !job(PagModule.globalPagKey).isInstanceOf[org.sireum.amandroid.pointsToAnalysis.PointerAssignmentGraph[org.sireum.amandroid.pointsToAnalysis.PtaNode]]) {
      tags += PipelineUtil.genTag(PipelineUtil.ErrorMarker, 
        "Output error for '" + this.title + "': Wrong type found for PagModule.globalPagKey.  Expecting 'org.sireum.amandroid.pointsToAnalysis.PointerAssignmentGraph[org.sireum.amandroid.pointsToAnalysis.PtaNode]' but found '" + 
  ...
  def getAndroidLibInfoTables (options : scala.collection.Map[Property.Key, Any]) : org.sireum.amandroid.AndroidSymbolResolver.AndroidLibInfoTables = {
    if (options.contains(PagModule.globalAndroidLibInfoTablesKey)) {
       return options(PagModule.globalAndroidLibInfoTablesKey).asInstanceOf[org.sireum.amandroid.AndroidSymbolResolver.AndroidLibInfoTables]
    }
  ...
  def getPag (options : scala.collection.Map[Property.Key, Any]) : org.sireum.amandroid.pointsToAnalysis.PointerAssignmentGraph[org.sireum.amandroid.pointsToAnalysis.PtaNode] = {
    if (options.contains(PagModule.globalPagKey)) {
       return options(PagModule.globalPagKey).asInstanceOf[org.sireum.amandroid.pointsToAnalysis.PointerAssignmentGraph[org.sireum.amandroid.pointsToAnalysis.PtaNode]]
    }
    if (options.contains(PagModule.pagKey)) {
       return options(PagModule.pagKey).asInstanceOf[org.sireum.amandroid.pointsToAnalysis.PointerAssignmentGraph[org.sireum.amandroid.pointsToAnalysis.PtaNode]]
    }

    throw new Exception("Pipeline checker should guarantee we never reach here")
  }

  def setPag (options : MMap[Property.Key, Any], pag : org.sireum.amandroid.pointsToAnalysis.PointerAssignmentGraph[org.sireum.amandroid.pointsToAnalysis.PtaNode]) : MMap[Property.Key, Any] = {
  ...
  object ConsumerView {
    implicit class PagModuleConsumerView (val job : PropertyProvider) extends AnyVal {
      ...
      def androidLibInfoTables : org.sireum.amandroid.AndroidSymbolResolver.AndroidLibInfoTables = PagModule.getAndroidLibInfoTables(job.propertyMap)
      def pag : org.sireum.amandroid.pointsToAnalysis.PointerAssignmentGraph[org.sireum.amandroid.pointsToAnalysis.PtaNode] = PagModule.getPag(job.propertyMap)
    }
  }
  ...
  object ProducerView {
    implicit class PagModuleProducerView (val job : PropertyProvider) extends AnyVal {
      ...
      def androidLibInfoTables_=(androidLibInfoTables : org.sireum.amandroid.AndroidSymbolResolver.AndroidLibInfoTables) { PagModule.setAndroidLibInfoTables(job.propertyMap, androidLibInfoTables) }
      def androidLibInfoTables : org.sireum.amandroid.AndroidSymbolResolver.AndroidLibInfoTables = PagModule.getAndroidLibInfoTables(job.propertyMap)

      def pag_=(pag : org.sireum.amandroid.pointsToAnalysis.PointerAssignmentGraph[org.sireum.amandroid.pointsToAnalysis.PtaNode]) { PagModule.setPag(job.propertyMap, pag) }
      def pag : org.sireum.amandroid.pointsToAnalysis.PointerAssignmentGraph[org.sireum.amandroid.pointsToAnalysis.PtaNode] = PagModule.getPag(job.propertyMap)
    }
  }
}
