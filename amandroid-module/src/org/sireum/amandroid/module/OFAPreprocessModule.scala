...
object OFAPreprocessModule extends PipelineModule {
  ...
  def outputDefined (job : PipelineJob) : MBuffer[Tag] = {
    ...
    if(job ? OFAPreprocessModule.OFGKey && !job(OFAPreprocessModule.OFGKey).isInstanceOf[org.sireum.amandroid.androidObjectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.objectFlowAnalysis.OfaNode]]) {
      tags += PipelineUtil.genTag(PipelineUtil.ErrorMarker, 
        "Output error for '" + this.title + "': Wrong type found for OFAPreprocessModule.OFGKey.  Expecting 'org.sireum.amandroid.androidObjectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.objectFlowAnalysis.OfaNode]' but found '" + 
        job(OFAPreprocessModule.OFGKey).getClass.toString + "'")
    } 

    if(job ? OFAPreprocessModule.globalOFGKey && !job(OFAPreprocessModule.globalOFGKey).isInstanceOf[org.sireum.amandroid.androidObjectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.objectFlowAnalysis.OfaNode]]) {
      tags += PipelineUtil.genTag(PipelineUtil.ErrorMarker, 
        "Output error for '" + this.title + "': Wrong type found for OFAPreprocessModule.globalOFGKey.  Expecting 'org.sireum.amandroid.androidObjectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.objectFlowAnalysis.OfaNode]' but found '" + 
        job(OFAPreprocessModule.globalOFGKey).getClass.toString + "'")
    } 
    return tags
  }

  def getOFG (options : scala.collection.Map[Property.Key, Any]) : org.sireum.amandroid.androidObjectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.objectFlowAnalysis.OfaNode] = {
    if (options.contains(OFAPreprocessModule.globalOFGKey)) {
       return options(OFAPreprocessModule.globalOFGKey).asInstanceOf[org.sireum.amandroid.androidObjectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.objectFlowAnalysis.OfaNode]]
    }
    if (options.contains(OFAPreprocessModule.OFGKey)) {
       return options(OFAPreprocessModule.OFGKey).asInstanceOf[org.sireum.amandroid.androidObjectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.objectFlowAnalysis.OfaNode]]
    }

    throw new Exception("Pipeline checker should guarantee we never reach here")
  }

  def setOFG (options : MMap[Property.Key, Any], OFG : org.sireum.amandroid.androidObjectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.objectFlowAnalysis.OfaNode]) : MMap[Property.Key, Any] = {
  ...
  object ConsumerView {
    implicit class OFAPreprocessModuleConsumerView (val job : PropertyProvider) extends AnyVal {
      def OFG : org.sireum.amandroid.androidObjectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.objectFlowAnalysis.OfaNode] = OFAPreprocessModule.getOFG(job.propertyMap)
  ...
  object ProducerView {
    implicit class OFAPreprocessModuleProducerView (val job : PropertyProvider) extends AnyVal {
      ...
      def OFG_=(OFG : org.sireum.amandroid.androidObjectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.objectFlowAnalysis.OfaNode]) { OFAPreprocessModule.setOFG(job.propertyMap, OFG) }
      def OFG : org.sireum.amandroid.androidObjectFlowAnalysis.AndroidObjectFlowGraph[org.sireum.amandroid.objectFlowAnalysis.OfaNode] = OFAPreprocessModule.getOFG(job.propertyMap)
