...
object AndroidApplicationPrepareModule extends PipelineModule {
  ...
  def outputDefined (job : PipelineJob) : MBuffer[Tag] = {
    ...
    if(job ? AndroidApplicationPrepareModule.appInfoOptKey && !job(AndroidApplicationPrepareModule.appInfoOptKey).isInstanceOf[scala.Option[org.sireum.amandroid.appInfo.PrepareApp]]) {
      tags += PipelineUtil.genTag(PipelineUtil.ErrorMarker, 
    ...
    if(job ? AndroidApplicationPrepareModule.globalAppInfoOptKey && !job(AndroidApplicationPrepareModule.globalAppInfoOptKey).isInstanceOf[scala.Option[org.sireum.amandroid.appInfo.PrepareApp]]) {
      tags += PipelineUtil.genTag(PipelineUtil.ErrorMarker, 
  ...
  def getAppInfoOpt (options : scala.collection.Map[Property.Key, Any]) : scala.Option[org.sireum.amandroid.appInfo.PrepareApp] = {
    if (options.contains(AndroidApplicationPrepareModule.globalAppInfoOptKey)) {
       return options(AndroidApplicationPrepareModule.globalAppInfoOptKey).asInstanceOf[scala.Option[org.sireum.amandroid.appInfo.PrepareApp]]
    }
    if (options.contains(AndroidApplicationPrepareModule.appInfoOptKey)) {
       return options(AndroidApplicationPrepareModule.appInfoOptKey).asInstanceOf[scala.Option[org.sireum.amandroid.appInfo.PrepareApp]]
    }
  ...
  object ConsumerView {
    implicit class AndroidApplicationPrepareModuleConsumerView (val job : PropertyProvider) extends AnyVal {
      ...
      def appInfoOpt : scala.Option[org.sireum.amandroid.appInfo.PrepareApp] = AndroidApplicationPrepareModule.getAppInfoOpt(job.propertyMap)
    }
  }
  ...
  object ProducerView {
    implicit class AndroidApplicationPrepareModuleProducerView (val job : PropertyProvider) extends AnyVal {
      ...
      def appInfoOpt_=(appInfoOpt : scala.Option[org.sireum.amandroid.appInfo.PrepareApp]) { AndroidApplicationPrepareModule.setAppInfoOpt(job.propertyMap, appInfoOpt) }
      def appInfoOpt : scala.Option[org.sireum.amandroid.appInfo.PrepareApp] = AndroidApplicationPrepareModule.getAppInfoOpt(job.propertyMap)
    }
  }
}
