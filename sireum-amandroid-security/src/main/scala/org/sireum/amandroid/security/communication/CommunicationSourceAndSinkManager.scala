 ...
 */ 
class CommunicationSourceAndSinkManager(appPackageName : String, 
	        ...
	        as.rhs match {
	          case le : LiteralExp =>
	            if(le.typ.name.equals("STRING")){
	              if(le.text.equals("content://call_log/calls"))
	                {flag = true}
                else if(le.text.equals("content://icc/adn"))
                       {flag = true}
                     else if(le.text.equals("content://com.android.contacts/contacts"))
                            {flag = true}
                          else if(le.text.equals("content://sms/"))
                               {flag = true}
	            }
	            false
	          case _ =>
