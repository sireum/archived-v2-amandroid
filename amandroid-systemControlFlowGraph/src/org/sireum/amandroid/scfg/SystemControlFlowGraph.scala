...
class sCfg[VirtualLabel] extends SystemControlFlowGraph[VirtualLabel]
    ...
    val BRANCH_PROPERTY_KEY = CompressedControlFlowGraph.BRANCH_PROPERTY_KEY
    ...
    def reverse : sCfg[VirtualLabel] = {
      val result = new sCfg[VirtualLabel]
...
//trait SystemControlFlowGraphBackup[VirtualLabel] extends CompressedControlFlowGraph[VirtualLabel] with AlirEdgeAccesses[SystemControlFlowGraph.Node]{
//  
