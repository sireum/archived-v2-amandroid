...
trait CallGraph {
  def CallMap : Map[ResourceUri, MSet[ResourceUri]]
  /**
   ...
   */
	 ...
	 */
	def getReachableProcedures(procedureUri : ResourceUri) : Set[ResourceUri]
	/**
	 ...
	 */
	def getReachableProcedures(procedureUris : Set[ResourceUri]) : Set[ResourceUri]
}