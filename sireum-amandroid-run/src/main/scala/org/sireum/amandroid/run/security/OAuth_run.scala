    ...
    files.foreach{
      file =>
        ...
        try{
          ...
          val pilarFileUri = Dex2PilarConverter.convert(Set(dexFile), FileUtil.toUri(srcFile.getParentFile()), dpsuri, _ => true, false, false)
      ...
      //        }
          ...
          System.gc()
          //OAuthCounter.write
          reporter.echo(TITLE, OAuthCounter.toString)
          reporter.echo(TITLE, "************************************\n")
        }
    }
  }
