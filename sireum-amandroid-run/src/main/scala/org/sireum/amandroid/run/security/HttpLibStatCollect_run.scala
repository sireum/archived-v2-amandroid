    ...
    files.foreach{
      file =>
        ...
        try{
          ...
          System.gc()
          Counter.write
          reporter.echo(TITLE, Counter.toString)
          reporter.echo(TITLE, "************************************\n")
        }
    }
  }
